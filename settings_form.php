...
<div id="tab-<?php echo $ad_number; ?>" style="padding: 0;">
  ...
  <div style="padding:0px 8px 16px 16px;">
     Block Name:  <input style="border-radius: 5px;" type="text" name="<?php echo AI_OPTION_NAME, WP_FORM_FIELD_POSTFIX, $ad_number; ?>" value="<?php echo $obj->get_ad_name() ?>" size="50" maxlength="50"/>
  </div>
...
<div id="tab-0" style="padding: 0 0 30px 0;">
  ...
  <div style="float: right; padding: 1px 5px;">
        <input style="display: none; border-radius: 5px;" name="<?php echo AD_FORM_SAVE; ?>" value="Save All Settings" type="submit" style="width:120px; font-weight: bold;" />
  </div>
...
<div style="height: 30px; margin: 8px 0 0 0;">
  ...
  <div style="float: right; padding: 1px 1px;">
        <input name="<?php echo AD_FORM_SAVE; ?>" value="Save All Settings" type="submit" style="display: none; width:120px; font-weight: bold;" />
  </div>
</div>
